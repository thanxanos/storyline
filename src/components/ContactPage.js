    ...
    <div className="contact-wrapper">
      <div className='accordion-wrapper'>
        <div className='accordion' id="faq">
          <h2 data-aos="fade-up" delay="80" data-aos-duration="1050">Common Questions</h2>
            {data.map((item, i)=>
              <div data-aos="fade-up" delay="150" data-aos-duration="1200" className='item'>
        ...
        <div id="customer-service">
          <h2 data-aos="fade-up" delay="80" data-aos-duration="1050">Customer Support</h2>
          <div data-aos="fade-up" delay="150" data-aos-duration="1200" className='customer-service-container'>
        ...
        <img data-aos="fade-up" delay="80" data-aos-duration="1050" className='logo-img' alt='book-logo-image' src={logoImg} />
        <div id="tos">
          <h2 data-aos="fade-up" delay="80" data-aos-duration="1050">Terms of Service</h2>
          <p data-aos="fade-up" delay="150" data-aos-duration="1200"><b>OVERVIEW</b></p>
            <div data-aos="fade-up" delay="150" data-aos-duration="1200">
